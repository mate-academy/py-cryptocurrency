...
def test_cryptocurrency_action_more_than(mocked_prediction) -> None:
    mocked_prediction.return_value = 1.08
    assert cryptocurrency_action(1) == "Buy more cryptocurrency"


def test_cryptocurrency_action_less_than(mocked_prediction):
    mocked_prediction.return_value = 0.8
    assert cryptocurrency_action(1) == "Sell all your cryptocurrency"


def test_cryptocurrency_action_donothing(mocked_prediction):
