...
class TestCryptocurrencyAction:
    ...
    def test_buy_more_cryptocurrency_edge_case(self, mock_get_prediction):
        current_rate = 100.0
    ...
    @patch('app.main.get_exchange_rate_prediction')
    def test_sell_all_cryptocurrency_edge_case(self, mock_get_prediction):
        current_rate = 100.0
    ...
    @patch('app.main.get_exchange_rate_prediction')
    def test_do_nothing_at_exact_upper_boundary(self, mock_get_prediction):
        current_rate = 100.0
    ...
    @patch('app.main.get_exchange_rate_prediction')
    def test_do_nothing_at_exact_lower_boundary(self, mock_get_prediction):
        current_rate = 100.0
