...
def test_should_return_buy_more_cryptocurrency(mock_get_exchange_rate_prediction):
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_should_return_sell_all_your_cryptocurrency(mock_get_exchange_rate_prediction):
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_should_return_do_nothing(mock_get_exchange_rate_prediction):
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_should_return_nothing(mock_get_exchange_rate_prediction):
