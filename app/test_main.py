...
def test_should_buy_more_when_predicted_rate_more_than_5_percent_higher() -> None:
    with patch("app.main.get_exchange_rate_prediction") as mock_pred:
        mock_pred.return_value = 105.01
        assert cryptocurrency_action(100) == "Buy more cryptocurrency"


def test_should_sell_all_when_predicted_rate_more_than_5_percent_lower() -> None:
    with patch("app.main.get_exchange_rate_prediction") as mock_pred:
