...
def test_buy_more(mock_choice, mock_random):
...
@mock.patch("app.main.random.random", return_value=0.1)
@mock.patch("app.main.random.choice", return_value="decrease")
def test_sell_all(mock_choice, mock_random):
    result = cryptocurrency_action(100)
...
@mock.patch("app.main.random.random", return_value=0.98)
@mock.patch("app.main.random.choice", return_value="decrease")
def test_do_nothing(mock_choice, mock_random):
    result = cryptocurrency_action(100)
