...
def test_cryptocurrency_action_over_1_05(mocked_prediction):
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_cryptocurrency_action_under_0_95(mocked_prediction):
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_cryptocurrency_action_between_0_95_and_1_05(mocked_prediction):
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_cryptocurrency_action_equal_1_05(mocked_prediction):
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_cryptocurrency_action_equal_0_95(mocked_prediction):
