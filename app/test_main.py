...
def test_advice_do_nothing(
    ...
    mocked_get_exchange_rate_prediction.return_value = 89.5
    assert cryptocurrency_action(85.5) == "Do nothing"
...
def test_advice_buy(
    ...
    mocked_random_choice.return_value = "increase"
    mocked_get_exchange_rate_prediction.return_value = 100.65
