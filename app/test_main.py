...
class TestCryptocurrencyAction(unittest.TestCase):
    ...
    def test_exchange_rate_more_than_5_percent_higher(
            self,
    ...
    @patch("app.main.get_exchange_rate_prediction")
    def test_exchange_rate_more_than_5_percent_lower(
            self,
            mock_exchange: int | float
    ) -> None:
    ...
    @patch("app.main.get_exchange_rate_prediction")
    def test_different_not_much(self, mock_exchange: int | float) -> None:
