...
def test_for_sale(mocked_cryptocurrency_test):
    mocked_cryptocurrency_test.return_value = 120
    assert cryptocurrency_action(100) == "Buy more cryptocurrency"


def test_for_buy(mocked_cryptocurrency_test):
    mocked_cryptocurrency_test.return_value = 100
    assert cryptocurrency_action(120) == "Sell all your cryptocurrency"


def test_for_do_nothing_when_rate_less_five_percent(mocked_cryptocurrency_test):
    mocked_cryptocurrency_test.return_value = 1.05
    assert cryptocurrency_action(1) == "Do nothing"


def test_do_nothing_percent_less_five(mocked_cryptocurrency_test):
