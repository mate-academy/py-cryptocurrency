...
def test_should_return_buy_more(mocked_predict: mock) -> None:
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_should_return_sell_all(mocked_predict: mock) -> None:
    mocked_predict.return_value = 266 * 0.945
    assert cryptocurrency_action(266) == "Sell all your cryptocurrency"


@mock.patch("app.main.get_exchange_rate_prediction")
def test_should_return_do_nothing(mocked_predict: mock) -> None:
