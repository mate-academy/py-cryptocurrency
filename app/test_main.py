...
def test_buy_more(mock_get_prediction: MagicMock) -> None:
    current = 100
...
@patch("app.main.get_exchange_rate_prediction")
def test_sell_all(mock_get_prediction: MagicMock) -> None:
    current = 100
...
@patch("app.main.get_exchange_rate_prediction")
def test_do_nothing_when_small_difference(
...
@patch("app.main.get_exchange_rate_prediction")
def test_boundary_upper(mock_get_prediction: MagicMock) -> None:
    current = 100
...
@patch("app.main.get_exchange_rate_prediction")
def test_boundary_lower(mock_get_prediction: MagicMock) -> None:
    current = 100
