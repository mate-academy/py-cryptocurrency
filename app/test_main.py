...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_rate_exactly_105_do_nothing(mock_get_exchange_rate_prediction: mock.Mock) -> None:
...
@mock.patch("app.main.get_exchange_rate_prediction")
def test_rate_exactly_95_do_nothing(mock_get_exchange_rate_prediction: mock.Mock) -> None:
